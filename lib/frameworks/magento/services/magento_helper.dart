...
class MagentoHelper {
  ...
  static String buildFilterCriteria({
    ...
    var filterCriteria =
        'searchCriteria[filter_groups][$filterGroupIndex][filters][$filterIndex][field]=$field';
    if (value != null) {
      filterCriteria +=
          '&searchCriteria[filter_groups][$filterGroupIndex][filters][$filterIndex][value]=$value';
    }
    if (conditionType != null) {
      filterCriteria +=
          '&searchCriteria[filter_groups][$filterGroupIndex][filters][$filterIndex][condition_type]=$conditionType';
    }
